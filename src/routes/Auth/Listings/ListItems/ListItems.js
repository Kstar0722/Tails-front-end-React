...
const ListItems = props => {
  ...
  const {id, title, created_at, pick_up_city, pick_up_state, desired_pick_up_date, delivery_city, delivery_state, desired_delivery_date, budget, other_notes, bids_count, images, animals} = props
    ...
    <div className="list-item">
      <div className="top-part">
        ...
        <div className="image-holder text-center">
          ...
          <img src={ (images.length) ? images['0'].url : '' } className="main-image" />
